...
def configure_mini_app(config, telegram: TelegramApi, db: Database, sources) -> None:
    ...
    if not config.mini_app_url:
        return
    try:
        if config.mini_app_menu_button:
            telegram.set_chat_menu_button(config.mini_app_menu_button_text or "Cabinet", config.mini_app_url)
        else:
...
def configure_bot_commands(telegram: TelegramApi) -> None:
    for language_code, descriptions in COMMAND_DESCRIPTIONS.items():
        telegram.set_my_commands(build_bot_commands(descriptions), None if language_code == DEFAULT_COMMAND_LANGUAGE else language_code)


DEFAULT_COMMAND_LANGUAGE = "en"
COMMAND_ORDER = (
    "start",
    "add",
    "remove",
...
ONBOARDING_COMMANDS = {"settings", "language", "country"}
COMMAND_DESCRIPTIONS = {
    "en": {
        ...
        "rss": "Manage sources",
        "tg": "Add a Telegram channel",
        "settings": "Language, region, and text mode",
        "language": "Change interface language",
        "country": "Change monitoring region",
        "tgblocks": "Manage TG packages",
        "info": "Show my monitoring",
        "sources": "Show sources",
        "sourcesfile": "Receive the source file",
        "check": "Check now",
        "report": "Receive CSV report",
        "help": "Help",
    },
    "uk": {
        "start": "Запустити бота і показати меню",
        "add": "Додати ключове слово",
        ...
        "tg": "Додати Telegram-канал",
        "settings": "Мова, регіон і режим тексту",
        "language": "Змінити мову інтерфейсу",
        "country": "Змінити регіон моніторингу",
        "tgblocks": "Керувати TG-пакетами",
        "info": "Показати мій моніторинг",
        "sources": "Показати джерела",
        "sourcesfile": "Отримати файл джерел",
        "check": "Перевірити зараз",
        "report": "Отримати CSV-звіт",
        "help": "Допомога",
    },
    "pl": {
        "start": "Uruchom bota i pokaż menu",
        "add": "Dodaj słowo kluczowe",
        ...
        "tg": "Dodaj kanał Telegram",
        "settings": "Język, region i tryb tekstu",
        "language": "Zmień język interfejsu",
        "country": "Zmień region monitoringu",
        "tgblocks": "Zarządzaj pakietami TG",
        "info": "Pokaż mój monitoring",
        "sources": "Pokaż źródła",
        "sourcesfile": "Odbierz plik źródeł",
        "check": "Sprawdź teraz",
        "report": "Odbierz raport CSV",
        "help": "Pomoc",
    },
    "de": {
        "start": "Bot starten und Menü anzeigen",
        "add": "Suchwort hinzufügen",
        ...
        "tg": "Telegram-Kanal hinzufügen",
        "settings": "Sprache, Region und Textmodus",
        "language": "Oberflächensprache ändern",
        "country": "Monitoring-Region ändern",
        "tgblocks": "TG-Pakete verwalten",
        "info": "Mein Monitoring anzeigen",
        "sources": "Quellen anzeigen",
        "sourcesfile": "Quelldatei erhalten",
        "check": "Jetzt prüfen",
        "report": "CSV-Bericht erhalten",
        "help": "Hilfe",
    },
    "es": {
        "start": "Iniciar el bot y mostrar el menú",
        ...
        "tg": "Añadir canal de Telegram",
        "settings": "Idioma, región y modo de texto",
        "language": "Cambiar idioma de interfaz",
        "country": "Cambiar región de monitoreo",
        "tgblocks": "Gestionar paquetes TG",
        "info": "Mostrar mi monitoreo",
        "sources": "Mostrar fuentes",
        "sourcesfile": "Recibir archivo de fuentes",
    ...
    "it": {
        ...
        "rss": "Gestisci fonti",
        "tg": "Aggiungi canale Telegram",
        "settings": "Lingua, regione e modalità testo",
        "language": "Cambia lingua interfaccia",
        "country": "Cambia regione di monitoraggio",
        "tgblocks": "Gestisci pacchetti TG",
        "info": "Mostra il mio monitoraggio",
        "sources": "Mostra fonti",
        "sourcesfile": "Ricevi file fonti",
        "check": "Controlla ora",
        "report": "Ricevi report CSV",
        "help": "Aiuto",
    },
    "be": {
        "start": "Запусціць бота і паказаць меню",
        "add": "Дадаць ключавое слова",
        ...
        "tg": "Дадаць Telegram-канал",
        "settings": "Мова, рэгіён і рэжым тэксту",
        "language": "Змяніць мову інтэрфейсу",
        "country": "Змяніць рэгіён маніторынгу",
        "tgblocks": "Кіраваць TG-пакетамі",
        "info": "Паказаць мой маніторынг",
        "sources": "Паказаць крыніцы",
        "sourcesfile": "Атрымаць файл крыніц",
    ...
    "ru": {
        ...
        "tg": "Добавить Telegram-канал",
        "settings": "Язык, регион и режим текста",
        "language": "Изменить язык интерфейса",
        "country": "Изменить регион мониторинга",
        "tgblocks": "Управлять TG-пакетами",
        "info": "Показать мой мониторинг",
        "sources": "Показать источники",
        "sourcesfile": "Получить файл источников",
...
def build_bot_commands(descriptions: dict[str, str]) -> list[dict[str, str]]:
    return [
        {"command": command, "description": descriptions[command]}
        for command in COMMAND_ORDER
        if REQUIRE_ONBOARDING or command not in ONBOARDING_COMMANDS
    ]
