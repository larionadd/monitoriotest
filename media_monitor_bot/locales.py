...
EXTRA_MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "prompt_add_rss": "Send a site URL or RSS feed URL. Example:\nhttps://example.com\nhttps://example.com/rss.xml",
        ...
        "rss_add_format": "Format: /rss add https://example.com or /rss add https://example.com/rss.xml",
        ...
        "invalid_rss_url": "Send a valid site URL or RSS feed URL.",
        "rss_read_failed": "Could not find a readable RSS feed for this URL. Check the site and try again.",
    ...
    "uk": {
        ...
        "prompt_add_rss": "Надішліть URL сайту або RSS-стрічки. Наприклад:\nhttps://example.com\nhttps://example.com/rss.xml",
        ...
        "rss_add_format": "Формат: /rss add https://example.com або /rss add https://example.com/rss.xml",
        ...
        "invalid_rss_url": "Надішліть коректний URL сайту або RSS-стрічки.",
        "rss_read_failed": "Не вдалося знайти читабельну RSS-стрічку за цим URL. Перевірте сайт і спробуйте ще раз.",
...
RU_MESSAGES.update(
    {
        ...
        "prompt_add_rss": "Отправьте URL сайта или RSS-ленты. Например:\nhttps://example.com\nhttps://example.com/rss.xml",
        ...
        "rss_add_format": "Формат: /rss add https://example.com или /rss add https://example.com/rss.xml",
        ...
        "top_block_first": "Топ 50 ({start}-{end})",
        "top_block": "Топ {end} ({start}-{end})",
        "invalid_rss_url": "Отправьте корректный URL сайта или RSS-ленты.",
        "rss_read_failed": "Не удалось найти читаемую RSS-ленту по этому URL. Проверьте сайт и попробуйте еще раз.",
